...
<?= $this->section('content') ?>
    <div class="m-4 gap-2">
        ...
        <h1 class="font-bold text-2xl my-4">Workshops</h1>
        <div class="grid gap-y-2">
            ...
            <div class="card card-side bg-base-100 shadow-xl">
                <figure>
                    <img
                            class="h-32 ml-8"
                            src="<?= base_url('assets/image/workshop/'.$w['image']) ?>"
                            alt="kegiatan 1" />
                </figure>
                <div class="card-body">
                    <div class="card-actions justify-end">
                        ...
                        <button onclick="deleteWorkshop(<?= $w['id_workshop'] ?>)">
                            <svg  xmlns="http://www.w3.org/2000/svg"
                                  width="24"
                                  height="24"
                                  viewBox="0 0 24 24"
                                  ...
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                  class="text-red-500"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M10 10l4 4m0 -4l-4 4" /></svg>
                        </button>
                    </div>
                    <h2 class="card-title"><?= $w['nama'] ?></h2>
                    <p class="flex gap-2">
                        <svg  xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php  echo Carbon::parse($w['jam_mulai'])->translatedFormat('H:i'); ?> - <?php echo Carbon::parse($w['jam_selesai'])->translatedFormat('H:i');?> WIB
                    </div>
                    </p>
                </div>
            </div>
    ...
    <script>
        function deleteWorkshop(id) {
            if (confirm('Yakin ingin menghapus workshop ini?')) {
                fetch('/dashboard/workshop/' + id, {
                    method: 'DELETE',
                    headers: {
